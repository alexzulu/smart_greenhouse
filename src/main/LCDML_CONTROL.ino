...
// settings
  #define _LCDML_CONTROL_analog_pin              A15
  // when you did not use a button set the value to zero
  #define _LCDML_CONTROL_analog_enter_min        810     // Button Enter
  #define _LCDML_CONTROL_analog_enter_max        850  
  #define _LCDML_CONTROL_analog_up_min           540     // Button Up
  #define _LCDML_CONTROL_analog_up_max           580   
  #define _LCDML_CONTROL_analog_down_min         680     // Button Down
  #define _LCDML_CONTROL_analog_down_max         720   
  #define _LCDML_CONTROL_analog_back_min         0       // Button Back
  #define _LCDML_CONTROL_analog_back_max         100   
  #define _LCDML_CONTROL_analog_left_min         320     // Button Left
  #define _LCDML_CONTROL_analog_left_max         360   
  #define _LCDML_CONTROL_analog_right_min        760     // Button Right
  #define _LCDML_CONTROL_analog_right_max        800
// *********************************************************************
// setup
void LCDML_CONTROL_setup()
{
